...
class Trainer(object):
    ...
    def get_optimizer_grouped_parameters(self, model):
        ...
        #print([p[0] for p in param_optimizer])
        ...
        not any(nd in n for nd in slow_lr) ], 'weight_decay': self.args.weight_decay,
         ...
         any(nd in n for nd in slow_lr) ], 'weight_decay': self.args.weight_decay,
             'lr': self.args.lr[0]*self.args.lr_slow_rate},
    ...
    def _build_optimizer(self):
        if "seqie" in self.args.task:
            params=self.get_optimizer_grouped_parameters(self.model)            
