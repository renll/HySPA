...
class FairseqAdam(FairseqOptimizer):
    ...
    def __init__(self, args, params):
        ...
        if getattr(args, "tpu", False):
            ...
            #self._optimizer = torch.optim.AdamW(self.optimizer_config)
 ...
 #self.p    
    ...
    def set_lr(self, lr):
        ...
        self.param_groups[1]["lr"] = lr*self.args.lr_slow_rate
        self.param_groups[2]["lr"] = lr*self.args.lr_slow_rate
        self.param_groups[0]["lr"] = lr
        self.param_groups[3]["lr"] = lr
